...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.c_tab_bg;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs,
        ...
        a = context.obtainStyledAttributes(attrs,
                R.styleable.CPagerSlidingTabStrip);

        indicatorColor = a.getColor(
                R.styleable.CPagerSlidingTabStrip_pstsIndicatorColor,
                indicatorColor);
        underlineColor = a.getColor(
                R.styleable.CPagerSlidingTabStrip_pstsUnderlineColor,
                underlineColor);
        dividerColor = a
                .getColor(R.styleable.CPagerSlidingTabStrip_pstsDividerColor,
                        dividerColor);
        indicatorHeight = a.getDimensionPixelSize(
                R.styleable.CPagerSlidingTabStrip_pstsIndicatorHeight,
                indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(
                R.styleable.CPagerSlidingTabStrip_pstsUnderlineHeight,
                underlineHeight);
        dividerPadding = a.getDimensionPixelSize(
                R.styleable.CPagerSlidingTabStrip_pstsDividerPadding,
                dividerPadding);
        tabPadding = a.getDimensionPixelSize(
                R.styleable.CPagerSlidingTabStrip_pstsTabPaddingLeftRight,
                tabPadding);
        tabBackgroundResId = a.getResourceId(
                R.styleable.CPagerSlidingTabStrip_pstsTabBackground,
                tabBackgroundResId);
        shouldExpand = a
                .getBoolean(R.styleable.CPagerSlidingTabStrip_pstsShouldExpand,
                        shouldExpand);
        scrollOffset = a
                .getDimensionPixelSize(
                        R.styleable.CPagerSlidingTabStrip_pstsScrollOffset,
                        scrollOffset);
        textAllCaps = a.getBoolean(
                R.styleable.CPagerSlidingTabStrip_pstsTextAllCaps, textAllCaps);
        tabSwitch = a.getBoolean(
                R.styleable.CPagerSlidingTabStrip_pstsTabSwitch, tabSwitch);
        tabTextColor = a.getColor(
                R.styleable.CPagerSlidingTabStrip_pstsActivateTextColor,
                tabTextColor);
        tabDeactivateTextColor = a.getColor(
                R.styleable.CPagerSlidingTabStrip_pstsDeactivateTextColor,
