...
public class MultiEdittextListItemMatchDialog extends Dialog {
    ...
    public MultiEdittextListItemMatchDialog(final Context context, String defaultMsg, final List<MultiSpinnerList> selectItems, final List<MultiSpinnerList> questions, int resId, final ItemPickerListner dtp,String total) {
        super(context);
        dismiss();
