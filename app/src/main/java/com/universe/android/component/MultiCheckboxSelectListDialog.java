 ...
 */
public class MultiCheckboxSelectListDialog extends Dialog {
    final ArrayList<MultiSpinnerList> arrSearlist = new ArrayList<>();
    SelectionItemAdapter adapter;
    ListView listView;
    private String searchText = "";

    public MultiCheckboxSelectListDialog(final Context context, String defaultMsg, final List<MultiSpinnerList> selectItems, final List<MultiSpinnerList> questions, int resId, final ItemPickerListner dtp) {
        super(context);
        dismiss();
        ...
        dialogView.findViewById(R.id.tvDone).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dtp.OnDoneButton(MultiCheckboxSelectListDialog.this, selectItems);
            }
        });
        dialogView.findViewById(R.id.tvCancel).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dtp.OnCancelButton(MultiCheckboxSelectListDialog.this, selectItems);
            }
        });
